        ...
        implements Filterable
{
    ...
    private class PokemonFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            String pokeString = constraint.toString();
            if (pokeString.isEmpty()){
                filteredPokemon = pokemon;
            } else {
                List<Pokemon> tempfilteredlist = new ArrayList<>();
                for (Pokemon row: pokemon) {
                    if (row.getName().toLowerCase().contains(pokeString.toLowerCase())){
                        tempfilteredlist.add(row);
                    }
                }
                filteredPokemon = tempfilteredlist;
            }
